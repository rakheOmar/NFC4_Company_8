...
const SentimentSummary = () => {
  ...
  <div className="bg-white shadow rounded p-4">
    ...
    <h3 className="text-2xl font-semibold text-blue-600">{totalResponses.total}</h3>
  </div>
  <div className="bg-white shadow rounded p-4">
    <p className="text-gray-500 text-sm">Positive</p>
    <h3 className="text-2xl font-semibold text-green-600">{totalResponses.pos}</h3>
  </div>
  <div className="bg-white shadow rounded p-4">
  ...
  <div className="bg-white shadow rounded p-4">
    ...
    <h3 className="text-2xl font-semibold text-red-600">{totalResponses.neg}</h3>
  </div>
</div>
